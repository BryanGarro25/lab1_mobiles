...
public class LoginView extends javax.swing.JFrame implements java.util.Observer {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        if (this.validar()) {
            ...
            JOptionPane.showMessageDialog(this, "Datos insuficientes", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    boolean validar() {
        ...
        this.jLabel1.setForeground(FrontendDesktop.COLOR_OK);
        if (this.id.getText().isEmpty()) {
            this.jLabel1.setForeground(FrontendDesktop.COLOR_ERROR);
            this.id.setBorder(BorderFactory.createLineBorder(FrontendDesktop.COLOR_ERROR, 1));
            error = true;
        }

        this.jLabel2.setForeground(FrontendDesktop.COLOR_OK);
        if ((new String(this.password.getPassword())).isEmpty()) {
            this.jLabel2.setForeground(FrontendDesktop.COLOR_ERROR);
            this.password.setBorder(BorderFactory.createLineBorder(FrontendDesktop.COLOR_ERROR, 1));
            error = true;
        }
